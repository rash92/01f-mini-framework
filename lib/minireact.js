...
function TodoList(props) {
  ...
  }, "test in middle of input"), createElement("p", null, "after input box"), createElement("p", null, "child 1"), [1, 2, 3]);
}

/** @jsx createElement */
function TodoItem(props) {
  console.log("props of todoitem: ", props, "children of todoitem: ", props.children);
  return createElement("div", null, props.children[0]);
}
var todolist = createElement(TodoList, {
  testpropnum: 3,
  testproptext: "test"
}, createElement(TodoItem, null, "test child for todo item 1"));
