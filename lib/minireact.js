...
function Counter(props) {
  ...
  var _useState3 = useState(1),
    ...
    state2 = _useState4[0],
    setState2 = _useState4[1];
  var _useState5 = useState(""),
    _useState6 = _slicedToArray(_useState5, 2),
    state3 = _useState6[0],
    setState3 = _useState6[1];
  ...
  }, "Count: ", state), createElement("h3", {
    onDblclick: function onDblclick() {
      console.log("ondblclick activated");
      return setState2(function (c) {
        return c + 2;
      });
    }
  }, "Count2: ", state2), createElement("h4", {
    onKeyDown: function onKeyDown(e) {
      return setState3(function (c) {
        return c + e;
      });
    }
  }, "keypresses: ", state3));
}
var funcElement = createElement(Counter, null);
...
function TodoList(props) {
  ...
  Object.keys(props).forEach(function (key) {
    return console.log("property key: ", key, "prop value: ", props[key], "prop type: ", _typeof(props[key]));
  });
  ...
  return createElement("div", null, createElement("p", null, "before input box"), createElement("input", {
    id: "todo-input",
    type: "text",
    "class": "new-todo",
    placeholder: "next task?"
  }, "test in middle of input"), createElement("p", null, "after input box"), createElement("p", null, "child 1: ", children[0]));
}

/** @jsx createElement */
function TodoItem(props) {
  console.log("props of todoitem: ", props, "value of todoitem: ", props.children[0].props.nodeValue);
  return createElement("div", null, props.children[0].props.nodeValue);
}
var todolist = createElement(TodoList, {
  testpropnum: 3,
  testproptext: "test"
}, createElement(TodoItem, null, "test child for todo item 1"), createElement(TodoItem, null, "second test child for todo item 1"));
var todoitem = createElement(TodoItem, null, "todo item 1");
