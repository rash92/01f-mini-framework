...
function TodoList(_ref) {
  ...
  var handleKeyDown = function handleKeyDown(e) {
    if (e.key === "Enter") {
      setTasklist(function (oldArr) {
        return [].concat(_toConsumableArray(oldArr), [createElement(TodoItem, null, preview)]);
      });
      setPreview(function () {
        return "";
      });
  ...
  var task1 = taskList[0] ? taskList[0].props : "";
  ...
  return [createElement("section", {
    ...
    className: "todo-list"
  }, taskList)), createElement("footer", {
    className: "footer"
  }, createElement("span", {
    className: "todo-count"
  }, "x items left"), createElement("ul", {
    className: "filters"
  ...
  }, "Clear Completed"))), createElement("footer", {
    className: "info"
...
function TodoItem(_ref2) {
  ...
  var _useState11 = useState(false),
    ...
    complete = _useState12[0],
    setComplete = _useState12[1];
  return createElement("li", null, createElement("div", null, createElement("input", {
    className: "toggle",
    type: "checkbox",
    onClick: function onClick() {
      return setComplete(function (complete) {
        return !complete;
      });
    }
  }), createElement("label", null, "To do item: ", children)));
}
var todoitem = createElement(TodoItem, null, "todo item in variable");
var todolist = createElement(TodoList, null, createElement(TodoItem, null, "test child for todo item 1"), createElement(TodoItem, null, "second test child for todo item 1"), todoitem);
