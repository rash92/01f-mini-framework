...
function TodoList(_ref) {
  ...
  var increaseCompletedCount = function increaseCompletedCount() {
  ...
  var decreaseCompletedCount = function decreaseCompletedCount() {
    setCompletedCount(function (prev) {
      return prev - 1;
    });
  };
  ...
  var handleKeyDown = function handleKeyDown(e) {
    if (e.key === "Enter") {
      ...
      setTasklist(function (oldArr) {
        return [].concat(_toConsumableArray(oldArr), [createElement(TodoItem, {
  ...
  return [createElement("section", {
    ...
    onClick: increaseCompletedCount
...
function TodoItem(_ref2) {
  var children = _ref2.children,
    ...
    onUncomplete = _ref2.onUncomplete;
  // const [complete, setComplete] = useState(false);
  return createElement("li", null, createElement("div", null, createElement("input", {
    className: "toggle",
    type: "checkbox",
    onClick: onComplete
  }), createElement("label", null, "To do item: ", children), createElement("button", {
    className: "destroy",
    onClick: function onClick() {
      return console.log("tried to destroy item, not implemented yet");
    }
  })));
}
