...
function TodoList(_ref) {
  ...
  var _useState5 = useState(0),
    ...
    completedCount = _useState6[0],
    setCompletedCount = _useState6[1];
  ...
  var handleKeyDown = function handleKeyDown(e) {
    if (e.key === "Enter") {
      ...
      setTasklist(function (oldArr) {
        return [].concat(_toConsumableArray(oldArr), [createElement(TodoItem, null, newTask)]);
      });
      e.target.value = "";
    } else {
...
function TodoItem(_ref2) {
  ...
  return createElement("li", null, createElement("div", null, createElement("input", {
    ...
    onClick: function onClick() {
      return setComplete(function (old) {
        return !old;
      });
    }
    ...
    className: "destroy",
    onClick: function onClick() {
      return console.log("tried to destroy item");
    }
  })));
}
