...
function App() {
  ...
  var clearCompleted = function clearCompleted() {
    ...
    setTasklist(function (taskList) {
      return _toConsumableArray(taskList.filter(function (task) {
        return !task.completed;
      }));
    });
...
function TodoItem(_ref3) {
  var text = _ref3.text,
    id = _ref3.id,
    onToggleComplete = _ref3.onToggleComplete,
  ...
  var viewingItem = createElement("div", {
    className: "view"
  }, createElement("input", {
    className: "toggle",
    type: "checkbox",
    ...
    onKeyDown: onKeyDown
  }, "To do item id: ", id, ": ", text, ", "), createElement("button", {
    className: "destroy",
    onClick: function onClick() {
      return onDelete(id);
    }
  }));
  var editingItem = createElement("div", {
    className: "view"
  }, createElement("input", {
    onKeyDown: onKeyDown,
  ...
  return createElement("li", null, editing ? editingItem : viewingItem);
}
function ToDoListFooter(_ref4) {
  var onClear = _ref4.onClear,
    completedCount = _ref4.completedCount;
  return createElement("footer", {
    ...
    className: "filters"
  }, createElement("li", null, createElement("a", null, "all")), createElement("li", null, createElement("a", null, "active")), createElement("li", null, createElement("a", null, "completed 2"))), createElement("button", {
